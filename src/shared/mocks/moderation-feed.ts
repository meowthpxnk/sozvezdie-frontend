...
export const MODERATION_PROPOSALS: ModerationProposal[] = [
    {
        ...
        previewImageUrl: "https://placehold.co/1200x900?text=Mock+Photo",
        changes: [
    ...
    },
    {
        ...
        changes: [
            ...
            { label: "Описание", before: "Колье из серебра 925.", after: "Колье из серебра 925 с покрытием родием." },
            {
                ...
                after: "new-cover.jpg",
                beforeImageUrl: "https://placehold.co/1200x900?text=Mock+Photo",
                afterImageUrl: "https://placehold.co/1200x900?text=Mock+Photo",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        previewBannerUrl: "https://placehold.co/1400x700?text=Mock+Photo",
        previewAvatarUrl: "https://placehold.co/300x300?text=Mock+Photo",
        changes: [
            ...
            { label: "Описание бренда", before: "Текстиль и свечи.", after: "Домашний декор ручной работы и авторские свечи." },
            {
                ...
                after: "banner-v2.jpg",
                beforeImageUrl: "https://placehold.co/1400x700?text=Mock+Photo",
                afterImageUrl: "https://placehold.co/1400x700?text=Mock+Photo",
            },
        ],
    },
    {
